...
/**
 * Абстрактний клас `Computer` є базовим класом для представлення комп'ютера з різними компонентами
 * @author Amina
 * @version 1.0
 */
public abstract class Computer{
    ...
    /**
     * Конструктор класу Computer без параметрів
     *
     * @throws IOException виняток, який може виникнути при створенні лог-файлу
     */
...
class RAM {
    ...
    /**
     * Конструктор класу RAM ініціалізує обсяг оперативної пам'яті
     *
